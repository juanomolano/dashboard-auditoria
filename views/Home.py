...
def render_home():
    ...
    # ---------------------------------------------------------
    # CARGA DE DATOS Y ESTANDARIZACIÓN (CÓDIGO ORIGINAL QUE FUNCIONABA)
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 🎛️ FILTROS SUPERIORES (CÓDIGO ORIGINAL EXACTO)
    # ---------------------------------------------------------
    st.markdown(
        """
    ...
    # ---------------------------------------------------------
    # 📌 KPIS SUPERIORES (CON EL PROMEDIO GENERAL AGREGADO)
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 📊 PROMEDIO POR REGIONAL (SIN ALTERAR LOS FILTROS ORIGINALES)
    # ---------------------------------------------------------
    if not df_merged.empty and sel_regional == "TODAS":
        st.markdown("---")
        st.subheader("📊 Promedio Porcentual por Regional")
