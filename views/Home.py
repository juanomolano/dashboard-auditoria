...
def render_home():
    ...
    if not df_merged.empty:
        ...
        with reg_col1:
            ...
            cols_show_reg = ["REGIONAL", "Tiendas_Auditadas", "Total_Hallazgos", "% Visita Inicial", "% Porcentaje Final", "Estado Regional"]
            st.dataframe(
                df_show_reg[cols_show_reg],
                use_container_width=True,
                hide_index=True
            )
        ...
        with reg_col2:
            ...
            fig_bar_reg = px.bar(
                df_regional_pct,
                x="REGIONAL",
                y="Promedio_Porcentaje_Final",
                text="Promedio_Porcentaje_Final",
        ...
        st.info("Sin datos para generar la consolidación por regional.")
